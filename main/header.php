...
<header>
        ...
        <div id="id01" class="modal">
            ...
            <form class="modal-content" action="../main/login.php" method="POST">
                ...
                <div class="container">
                    ...
                    <input type="text" name="uname_login" required>
            
                    <label for="psw"><b>Contraseña</b></label>
                    <input type="password" name="psw_login" required>
        ...
        <div id="id02" class="modal">
            ...
            <form class="modal-content" action="../main/registro.php" method="POST">
                <div class="imgcontainer">
                    <img src="../img/UEM-usuario.png" alt="Avatar" class="avatar">
                </div>
                ...
                <div class="container">
                        ...
                        <input type="text" name="uname_registro" required>
                        <label for="lname"><b>Apellidos</b></label>
                        <input type="text" name="lname_registro" required>
                        <label for="email"><b>Correo electrónico</b></label>
                        <input type="text" name="email_registro" required>
                        <label for="psw"><b>Contraseña</b></label>
                        <input type="password" name="psw_registro" required>
